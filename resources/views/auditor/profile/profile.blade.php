            ...
            <div class="card p-3 mb-5 border-0">
                ...
                <div class="row">
                    <div class="col-2">
                        ...
                        <a href="/auditor/{{ auth()->id() }}/change_password" class="unstyled text-light badge bg-primary">Ganti Password</a>
                    ...
                    <div class="col">
                        <div class="row g-5 align-items-center">
                            <div class="col-8 mb-3">
                                <form action="/auditor/{{ auth()->id() }}/update/profile" method="post">
                                    @csrf
                                    ...
                                    <a href="{{ route('auditor.dashboard') }}"><button type="button" id="kembali" class="btn btn-secondary btn-sm">Kembali</button></a>
                                </form>
                            </div>
                        </div>
                    </div>
